...
<body>
    ...
    switch ($couleur) {
        ...
        case "vert":
            ...
            break;
            // Un break pour passer au case suivant ci il n'est pas vérifié
            // Le breal doit être codé pour chaque case. Sinon , même si le case il ca aller tester le code suivant
        case "bleu":
