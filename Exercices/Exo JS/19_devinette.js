console.log("Hello et Bienvenue");

// Cette ligne génère aléatoirement un nombre entre 1 et 100.
var solution = Math.floor(Math.random() * 100 +1);

// La fonction Math.floor renvoie le plus grand entier qui est égal à un nombre.
// La fonction Math.random renvoie un nombre à virgule supérieur ou égal 0 et inférieur à 1.
console.log("(La solution est " + solution + " )");


// var nombre = prompt("Entrer un nombre entre 1 et 100");
