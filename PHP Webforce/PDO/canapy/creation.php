...
require_once('./lib/insert_article.php');
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" name="titleArticle">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="text-black" for="lname">Prix</label>
                                        <input type="number" class="form-control" id="lname" name="priceArticle">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="text-black" for="email">Image de l'article</label>
                                <input type="file" class="form-control" id="email" name="imgArticle">
                            </div>
