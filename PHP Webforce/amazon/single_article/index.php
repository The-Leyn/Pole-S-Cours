    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../backoffice/img/uploads/<?php echo $product['image'] ?>" alt="..." /></div>
                <div class="col-md-6">
                    <div class="small mb-1">SKU: BST-498</div>
                    <h1 class="display-5 fw-bolder"><?php echo $product['title'] ?></h1>
                    <div class="fs-5 mb-5">
                        <span class="<?php if (!empty($product['discount'])) {
                                            echo "text-decoration-line-through text-muted";
                                        } ?>"><?php echo $product['price'] ?>€</span>
                        <?php if (!empty($product['discount'])) {
                            echo "<span>" . $product['price'] - $product['price'] * $product['discount'] / 100 . '€' . "</span>";
                        } ?>
                    </div>
